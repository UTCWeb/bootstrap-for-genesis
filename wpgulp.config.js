...
module.exports = {
	...
	// Project options.
	projectURL: 'wordpress.test', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	watchJsCustom: './assets/js/source/*.js', // Path to all custom JS files.
	watchPhp: './**/*.php', // Path to all PHP files.

	// Translation options.
	textDomain: 'bootstrap-for-genesis', // Your textdomain here.
	translationFile: 'bootstrap-for-genesis.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Bootstrap for Genesis', // Package name.
	bugReport: 'https://github.com/webdevsuperfast/bootstrap-for-genesis/issues', // Where can users report bugs.
